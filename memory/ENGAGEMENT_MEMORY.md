...
- **Status:** ACTIVE
- **Memory status:** FINAL WORKING VERSION AFTER QA BOOTSTRAP + GLOBAL RECONCILIATION
...
- **Persistence note:** this content is ready for canonical Engagement Memory persistence, but no canonical repository write is claimed from this runtime.
...
### Funding Decision, Funding Agreement and Project

**Funding Decision ≠ Funding Agreement ≠ Project.**

A Funding Decision may justify creation of a Project record, while Agreement processing, Project Setup, readiness and activation are separately governed. The exact cross-Part normalization of these lifecycle boundaries remains open.
...
### Budget Revision and Budget Version

**Budget Revision** is a controlled proposed change to an existing Budget.
...
1. Normalize Project `Created / Setup / Ready for Administration / Active / Pending Activation` semantics across Parts 00–03.
...
15. Exact Commitment → Actual → Available Budget calculation and double-counting prevention.
...
Substantial architecture baseline. Core scope, boundaries, principles and SoR model are usable. Contains several stale remnants / assertions that require controlled normalization before Part 04.
...
Substantial expanded baseline covering Pre-Award, Agreement / Project Initiation, Funding, Budget, Project Change, Research Team, Procurement, Services, Reporting, Payment, Reconciliation, Closure and cross-functional controls. Several lifecycle/state semantics must be synchronized with later Part 03 corrections.

### Part 03 — System Analysis

Advanced current system-behavior baseline covering Functional Requirements, Use Cases, System Context, State Models, Validation, Roles / Permissions, Integration Requirements and NFR. Most late validation corrections are incorporated. The Application State Model and several cross-Part terms still require normalization.
...
**Parts 00–03 require a controlled normalization pass before Part 04.** No redesign is implied; the objective is to eliminate known semantic contradictions before they become formal Data Domains, entities, states, relationships and constraints.
...
- Award/Funding Decision → Project creation versus Project readiness/activation distinction;
...
- Budget Revision versus Budget Version;
...
- Research Need versus downstream derived progress;
