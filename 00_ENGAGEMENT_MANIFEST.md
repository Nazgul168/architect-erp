...
Runtime Context: dedicated Engagement runtime — TO BE DEPLOYED  
Confidentiality: TO_CONFIRM  
Engagement Owner: Project owner / user  
...
- process/system/data architecture reasoning relevant to the ERP;
...
- automatic promotion of NURA-specific knowledge into global EKB.

## 3. ARCHITECT Runtime Binding

RUNTIME_ID: TO_BE_ASSIGNED  
...
EXECUTION_PROFILE_ID: TO_BE_ASSIGNED  
